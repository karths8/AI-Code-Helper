...
if args.big:
    ...
    design_dict = {'container_width':'620px', 'container_height':'500px', 'image_margin_left':'200px', 'button_margin': '100px', 'image_size_width': '150px', 'image_size_height': '150px', "image_margin_bottom": '20px'}
