...
def code_helper():
    ...
    if question_num=='finish':
        ...
        return render_template('index_nollm.html', results=results, student_code=code, question_num=num, question_str=question_str, num_of_questions=num_of_questions, error=error, total_score=total_score)
